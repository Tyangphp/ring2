<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"E:\wedring\public/../application/index\view\lists\help.html";i:1499777219;}*/ ?>
...
/*https://shop116998991.taobao.com/*/-->
  ...
  <title>帮助中心</title>
  <link href="/index/css/same.css?v=1.3.7.2" type="text/css" rel="stylesheet" />
  <link href="/index/css/aboutUs.css?v=1.3.5.0" type="text/css" rel="stylesheet" />
  <script src="/index/js/aboutUs.js" type="text/javascript"></script>
  <title>
     ...
     <div class="cs_top">
      <div class="cs_topcenter">
       ...
       <div style="width:385px; height:20px; float:left; text-align:right; padding-top:20px;">
        <img width="55" height="9" style="cursor: pointer;" onClick="CloseMaskser()" src="/index//index/images/popup_window_btn_close.gif" />
       </div>
      </div>
     </div>
