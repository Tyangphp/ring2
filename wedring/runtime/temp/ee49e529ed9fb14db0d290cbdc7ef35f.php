<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"E:\wedring\public/../application/index\view\index\brand.html";i:1500294380;}*/ ?>
...
/*https://shop116998991.taobao.com/*/-->
  ...
  <title>品牌文化</title>
  <link href="/index/css/same.css?v=1.3.7.2" type="text/css" rel="stylesheet" />
  <link href="/index/css/dr_culture.css?v=1.3.5.0" type="text/css" rel="stylesheet" />
    ...
    <div class="cmain">
     <div class="headtop">
      ...
      <div class="top-left fl">
       <a title="Darry Ring" href="index.html"> <img width="187" height="42" alt="Darry Ring官网" src="/index/images/logo.png" /> </a>
            ...
            <li><a href="/pinkdiamond.aspx" target="_blank">高级定制</a>
                <div class="nav-div">
                    ...
                    <div class="navdiv-left">
                        <h3>
                            NEW</h3>
                        <img src="/index/images/02wj.jpg" width="138" height="97" />
                        <div class="more_cp">
     ...
     <div class="cort">
      ...
      <div class="cmain culture_same">
       ...
       <div class="zbk_top spalid">
        <div class="zbk_top spalid">
         <span>您当前的位置：</span>
         <span id="ctl00_content_website_SiteMapPath1"><a href="#ctl00_content_website_SiteMapPath1_SkipLink"></a><span> <a target="_blank" href="index.html">Darry Ring</a> </span><span> <em>&gt;</em> </span><span> <span>品牌文化</span> </span><a id="ctl00_content_website_SiteMapPath1_SkipLink"></a></span>
        </div>
       </div>
       <!--面包屑end-->
       <!--标题-->
       ...
       <div class="culture_pp culture_first">
        <!--左边-->
        <div class="fl">
         <a target="_blank" href="/dr_brand.aspx"> <img width="470" height="300" src="/index/images/wh1.jpg" /> </a>
        </div>
        <!--左边end-->
        <!--右边-->
       ...
       <!--三大块-->
       <div class="three_yz">
        <a href="index.htmlbrand.html_tl" target="_blank"> <img width="300" height="426" src="/index/images/re1.jpg" /> </a>
        <a href="index.htmlbrand.html_pr" target="_blank"> <img width="300" height="426" src="/index/images/re2.jpg" /> </a>
        <a href="index.htmlbrand.html_zo" target="_blank"> <img width="300" height="426" src="/index/images/re3.jpg" /> </a>
       </div>
       <!--三大块end-->
       <!--社会名人-->
       <div class="culture_pp culture_sec">
        ...
        <div class="culture_sec-right fr">
         <a target="_blank" href="dr_mrtj.aspx"> <img width="367" height="250" src="/index/images/wh2.jpg" /> </a>
        </div>
        <!--右边end-->
       </div>
       <!--社会名人end-->
       ...
       <div class="culture_pp culture_thrid">
        ...
        <div class="culture_thrid-left fl">
         <a target="_blank" href="/shopyd"> <img width="367" height="230" src="/index/images/wh3.jpg" /> </a>
        </div>
        <!--左边end-->
        <!--右边-->
        <div class="culture_pp-word fr">
       ...
       <div class="culture_pp">
        ...
        <div class="culture_four-left fl">
         <img width="465" height="300" src="/index/images/wh4.jpg" />
         <!--透明背景-->
        ...
        <div class="culture_four-right fr">
         <img width="465" height="300" src="/index/images/wh5.jpg" />
         <!--DR族-->
         <div class="brand_drz">
          <h3> 真爱验证</h3>
          <h4> Brand Culture</h4>
       ...
       <div class="culture_pp">
        ...
        <div class="culture_last fl">
         <a target="_blank" href="http://bbs.darryring.com"> <img width="465" height="200" src="/index/images/wh6.jpg" /> </a>
        </div>
        <!--左边end-->
        <!--右边-->
        <div class="culture_last fr">
         <a target="_blank" href="brand.html_jo"> <img width="466" height="200" src="/index/images/wh7.jpg" /> </a>
        </div>
        <!--右边end-->
       </div>
       <!--DR社区与加入我们end-->
