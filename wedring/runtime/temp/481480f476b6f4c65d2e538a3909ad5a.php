<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"E:\wedring\public/../application/index\view\index\index.html";i:1500294884;}*/ ?>
﻿<html xmlns="http://www.w3.org/1999/xhtml" class="hb-loaded">
<head>
<title>Weding Ring珍爱一生</title>
<link href="/index/css/index_A.css?v=1.3.7.1" type="text/css" rel="stylesheet" />
<link href="/index/css/same_A.css?v=1.3.7.2" type="text/css" rel="stylesheet" />
<link rel="shortcut icon" href="/favicon.ico">

<script src="/index/js/jquery.js" type="text/javascript"></script>
<script src="/index/js/index.js?virsion=1.3.7.2" type="text/javascript"></script>
...
<body>
    ...
    <div class="cmain">
        <div class="headtop">
            ...
            <div class="top-left fl">
                <a title="Darry Ring" href="/index/index/index"> <img width="187" height="42" alt="Darry Ring官网" src="/index/images/logo.png" /> </a>
            ...
            <div class="top-right fr">
                ...
                <ul class="tright-ul fl">
                    <div id="ucheader1_pllogin1">
                        <li><a rel="nofollow" href="/index/user/login">登录</a><em>|</em></li>
                        <li><a rel="nofollow" href="/index/user/reg">注册</a></li>
                ...
                <div style="display:none;" class="search">
                    ...
                    <div onClick="showSearch()" class="icon toser"></div>
                </div>
            </div>
            <!--头部右边end-->
        </div>
    ...
    <div class="nav">
        <div class="cmain">
            ...
            <ul class="nav-ul fl">
                ...
                <li><a style="font-family:arial" href="/index/lists/lists">Darry Ring 求婚钻戒</a>
                    <div class="nav-div">
                        <div class="navdiv_top">
                            <div class="navdiv-right">
                                <p> <a href="/index/lists/lists"> 查看所有款</a></p>
                            ...
                            <div class="navdiv-left">
                                <h3> NEW</h3>
                                <a href="detail.html"> <img width="138" height="97" alt="2克拉钻戒价格_E色EX切工VVS2净度_True Love系列 奢华款 _Darry Ring求婚钻戒 戴瑞珠宝官网" src="/index/images/03wj.jpg" /></a>
                                <div class="more_cp">
                ...
                <li><a style="font-family:arial" href="/index/lists/lists">Darry Ring 爱的礼物</a>
                    <div class="nav-div">
                        <div class="navdiv_top">
                            <div class="navdiv-right">
                                <p> <a href="/index/lists/lists">查看所有</a></p>
                            ...
                            <div class="navdiv-right special_right noborder">
                                ...
                                <div class="more_cp">
                                    <a href="/index/lists/lists">&gt; 查看所有款</a>
                                </div>
                            </div>
                        </div>
                        <div class="navdiv_bottom"></div>
            ...
            <ul class="nav-right fr">
                <li class="lipos"><em></em><a href="active.html">最新活动</a> <i class="icon"></i>
                    ...
                    <a href="/xiaoshidai4.html"> <img width="187" height="163" alt="" src="/index/images/xsdcat.jpg" /></a>
                    </div>
                    </div>
                    <div class="navdiv_bottom"></div>
                    </div>
            ...
            <ul class="indexbanner">
                <li class="tb_first" style="display: block; opacity: 0.982279;">
                    <div class="cmain cb_main">
                        ...
                        <div class="banner-word sp_width">
                            <img src="/index/images/dr_logo.png" />
                ...
                <li class="tb_four" style="display: none;">
                    <div class="cmain cb_main">
                        ...
                        <div class="banner-word sp_width">
                            <img src="/index/images/spdr_logo.png" />
        ...
        <div class="all-thing">
            ...
            <div class="cmain">
                ...
                <ul class="news-ul">
                    ...
                    <li>
                        <div class="ul-top">
                            <a target="_blank" href="/shopyd"> <img width="235" height="130" alt="Darry Ring实体店" src="/index/images/tyzx.jpg" /> </a>
                        </div>
                        <div class="ul-center">
                    ...
                    <li>
                        <div class="ul-top">
                            <a target="_blank" href="brand.html"> <img width="235" height="130" alt="关于Darry Ring" src="/index/images/zajz.jpg" /> </a>
                        </div>
                        <div class="ul-center">
                    ...
                    <li>
                        <div class="ul-top">
                            <a target="_blank" href="brand.html_mr"> <img width="235" height="130" alt="社会名人倾情推荐" src="/index/images/famous.jpg" /> </a>
                        </div>
                        <div class="ul-center">
                    ...
                    <li>
                        <div class="ul-top">
                            <a target="_blank" href="/index/lists/lists"> <img width="235" height="130" alt="网络热门钻戒品牌" src="/index/images/wlzj.jpg" /> </a>
                        </div>
                        <div class="ul-center">
                            <a target="_blank" href="/index/lists/lists" class="">Darry Ring 定制</a>
                        </div>
                        <div class="ul-bottom"></div>
                    </li>
                </ul>
                ...
                <div class="ultab_all">
                    ...
                    <!--箭头end-->
                    <!--箭头-->
                    <div class="ul_bkjt-hover" style="width: 18px; left: 777.104px;"></div>
                    <!--箭头end-->
                </div>
                <!--tab选项卡ul end-->
                ...
                <ul class="all_tab">
                    <li style="display: none;">
                        ...
                        <div class="tab_left fl">
                            <a href="index.html/dr_series/12_22.html">
                                <img width="504" height="314" alt="Forever经典系列" src="/index/images/fimg6.jpg" />
                            </a>
                        </div>
                        <!--tab选项卡下的左边内容 end-->
                        ...
                        <div class="tab_right fr">
                            ...
                            <div class="more-ul">
                                <p>
                                    <a target="_blank" href="/dr_series/12_22.html">求婚钻戒</a>
                                    <a target="_blank" href="dr_phonics">结婚对戒</a> <a target="_blank" href="/j_series/22_12.html">饰品</a>
                                </p>
                            </div>
                        </div>
                        <!--tab选项卡下的右边内容  end-->
                    ...
                    <li style="display: none;">
                        <!--tab选项卡下的左边内容-->
                        <div class="tab_left fl">
                            <a href="/pinkdiamond.aspx">
                                <img width="504" height="314" alt="Marry Me系列" src="/index/images/fimg1.jpg" />
                            </a>
                        </div>
                        <!--tab选项卡下的左边内容 end-->
                    ...
                    <li style="display: none;">
                        <!--tab选项卡下的左边内容-->
                        <div class="tab_left fl">
                            <a href="/dr_series/11_20.html">
                                <img width="504" height="314" alt="My heart系列" src="/index/images/fimg2.jpg" />
                            </a>
                        </div>
                        <!--tab选项卡下的左边内容 end-->
                        ...
                        <div class="tab_right fr">
                            ...
                            <div class="more-ul">
                                <p>
                                    <a target="_blank" href="/dr_series/11_20.html">求婚钻戒</a> <a target="_blank" href="dr_phonics"> 结婚对戒</a>
                                    <a target="_blank" href="/j_series/20_11.html">饰品</a>
                                </p>
                            </div>
                        </div>
                        <!--tab选项卡下的右边内容  end-->
                    ...
                    <li style="display: list-item; opacity: 0.470565;">
                        <!--tab选项卡下的左边内容-->
                        <div class="tab_left fl">
                            <a href="/dr_series/16_30.html">
                                <img width="515" height="314" alt="True Love系列" src="/index/images/fimg3.jpg" />
                            </a>
                        </div>
                        <!--tab选项卡下的左边内容 end-->
                        ...
                        <div class="tab_right fr">
                            ...
                            <div class="more-ul">
                                <p>
                                    <a target="_blank" href="/dr_series/16_30.html">求婚钻戒</a>
                                    <a target="_blank" href="dr_phonics"> 结婚对戒</a>
                                    <a target="_blank" href="/j_series/30_16.html">饰品</a>
                                </p>
                            </div>
                        </div>
                        <!--tab选项卡下的右边内容  end-->
                    ...
                    <li style="opacity: 0.529435; display: list-item;">
                        <!--tab选项卡下的左边内容-->
                        <div class="tab_left fl">
                            <a href="/dr_series/15_18.html">
                                <img width="504" height="314" alt="I Swear系列" src="/index/images/fimg4.jpg" />
                            </a>
                        </div>
                        <!--tab选项卡下的左边内容 end-->
                        ...
                        <div class="tab_right fr">
                            ...
                            <div class="more-ul">
                                <p>
                                    <a target="_blank" href="/dr_series/15_28.html">求婚钻戒</a>
                                    <a target="_blank" href="dr_phonics"> 结婚对戒</a>
                                    <a target="_blank" href="/j_series/28_15.html">饰品</a>
                                </p>
                            </div>
                        </div>
                        <!--tab选项卡下的右边内容  end-->
                ...
                <!--推荐款式-->
                <div class="hot-ks">
                    <a class="fr" target="_blank" href="/index/lists/lists">更多</a>
                    ...
                    <ul id="ullist" class="buyit">
                        <li>
                            <div class="by_top">
                                ...
                                <div style="opacity:1" class="bything-one">
                                    <img width="236px" height="236px" alt="Forever系列 经典款&nbsp;50分&nbsp;H色" src="/index/images/2014090119350717386d7a1e.jpg" />
                                </div>
                                <div style="opacity:0" class="bything-two">
                                    <img width="236px" height="236px" src="/index/images/201409011935072849fe802f.jpg" />
                                </div>
                            </div>
                        ...
                        <li>
                            <div class="by_top">
                                <a target="_blank" href="detail.html" rel="nofollow"></a>
                                <div style="opacity:1" class="bything-one">
                                    <img width="236px" height="236px" alt="Forever系列 经典款&nbsp;40分&nbsp;D色" src="/index/images/201409011932585de1c2f2a9.jpg" />
                                </div>
                                <div style="opacity:0" class="bything-two">
                                    <img width="236px" height="236px" src="/index/images/20140901193258beafcb5eb7.jpg" />
                                </div>
                            </div>
                            <div class="by_center"></div>
                            <div class="by_bottom">
                        ...
                        <li>
                            <div class="by_top">
                                <a target="_blank" href="detail.html" rel="nofollow"></a>
                                <div style="opacity:1" class="bything-one">
                                    <img width="236px" height="236px" alt="True Love系列 简奢款&nbsp;30分&nbsp;E色" src="/index/images/2014091515351160b3d26880.jpg" />
                                </div>
                                <div style="opacity:0" class="bything-two">
                                    <img width="236px" height="236px" src="/index/images/20140901162336bad2605031.jpg" />
                                </div>
                            </div>
                            <div class="by_center"></div>
                            <div class="by_bottom">
                        ...
                        <li>
                            <div class="by_top">
                                <a target="_blank" href="detail.html" rel="nofollow"></a>
                                <div style="opacity:1" class="bything-one">
                                    <img width="236px" height="236px" alt="True Love系列 典雅&nbsp;40分&nbsp;F色" src="/index/images/201412081512070b82d519cb.jpg" />
                                </div>
                                <div style="opacity:0" class="bything-two">
                                    <img width="236px" height="236px" src="/index/images/20141208151207e3fa9cdc9e.jpg" />
                                </div>
                            </div>
                            <div class="by_center"></div>
                            <div class="by_bottom">
            ...
            <div class="cmain bkbook_all">
                ...
                <div class="bkbook_left fl">
                    ...
                    <div class="bkbook_left-first">
                        ...
                        <div class="bkleft_img fl">
                            <ul class="bkleft_banner">
                                <li style="display: block;">
                                    <a target="_blank" href="/news/4827.html">
                                        <img width="280px" height="180px" alt="小时代4剧情揭秘，杨幂戴DR真爱戒指或唯一存活" src="/index/images/20150707185244af94e583ea.jpg" />
                                    </a>
                                    <!--提示文字-->
                                    <div class="bnhide">
                                        <!--透明块-->
                                        ...
                                        <!--透明块里的文字-->
                                        <div class="ban_word">小时代4剧情揭秘，杨幂戴DR真爱戒指</div>
                                        <!--透明块里的文字end-->
                                    </div>
                                    <!--提示文字end-->
                                </li>
                                ...
                                <li style="display: none;">
                                    <a target="_blank" href="/news/4825.html">
                                        <img width="280px" height="180px" alt="最浪漫珠宝店Darry Ring7月7日登陆宁波" src="/index/images/20150707184746fa95671549.jpg" />
                                    </a>
                                    <!--提示文字-->
                                    <div class="bnhide">
                                        <!--透明块-->
                                        ...
                                        <!--透明块里的文字-->
                                        <div class="ban_word">最浪漫珠宝店Darry Ring7月7日登陆宁</div>
                                        <!--透明块里的文字end-->
                                    </div>
                                    <!--提示文字end-->
                                </li>
                                ...
                                <li style="display: none;">
                                    <a target="_blank" href="/news/4316.html">
                                        <img width="280px" height="180px" alt="戴瑞戒指价格知多少 价值连城的一生承诺" src="/index/images/20150707184853bf1307dd75.jpg" />
                                    </a>
                                    <!--提示文字-->
                                    <div class="bnhide">
                                        <!--透明块-->
                                        ...
                                        <!--透明块里的文字-->
                                        <div class="ban_word">戴瑞戒指价格知多少 价值连城的一生</div>
                                        <!--透明块里的文字end-->
                                    </div>
                                    <!--提示文字end-->
                                </li>
                        ...
                        <ul class="bkfirst_ul">
                            <li class="ts_list">
                                <h3> <a target="_blank" href="/news/4827.html"> 小时代4剧情揭秘，杨幂戴DR真爱戒指</a></h3>
                                <p> 小时代4剧情即将揭秘!作为《小时代》电影系列大结局的收官之作，《小时代4灵魂...[<a href="/news/4827.html">详情</a>]</p>
                            </li>

                            <li class="">
                                <h3> <a target="_blank" href="/news/4825.html"> 最浪漫珠宝店Darry Ring7月7日登陆宁</a></h3>
                                <p> 7月7日，是阳历上和七夕节恰巧对应的日子，代表现代的宁波DR族和牛郎织女一样即...[<a href="/news/4825.html">详情</a>]</p>
                            </li>

                            <li class="">
                                <h3> <a target="_blank" href="/news/4316.html"> 戴瑞戒指价格知多少 价值连城的一生</a></h3>
                                <p> 香港戴瑞珠宝被誉为最浪漫珠宝品牌。然而，戴瑞珠宝更为大众所知晓的名字，其实...[<a href="/news/4316.html">详情</a>]</p>
                            </li>
                        </ul>
                        <!--右边列表end-->
                    </div>
                    ...
                    <div class="bkbook_left-sec">
                        ...
                        <ul class="bkbook_left-secul">
                            <li>
                                <a class="fl" target="_blank" href="/news/3954.html"> 求婚钻戒第一品牌Darry R...</a>
                                <span class="fr"> 2015/7/7</span>
                            </li>

                            <li>
                                <a class="fl" target="_blank" href="/news/3534.html"> 求婚钻戒Darry Ring贵在...</a>
                                <span class="fr"> 2015/7/7</span>
                            </li>
                        </ul>
                        <!--左边ul end-->
                        ...
                        <ul class="bkbook_left-secul bkbook_left-spcul">
                            <li>
                                <a class="fl" target="_blank" href="/news/3042.html"> 2015年求婚告白词</a>
                                <span class="fr"> 2015/7/7</span>
                            </li>

                            <li>
                                <a class="fl" target="_blank" href="/news/2699.html"> 求婚买多大的钻戒合适?</a>
                                <span class="fr"> 2015/7/7</span>
                            </li>
                        </ul>
                        <!--右边ul end-->
                ...
                <div class="bkbook_right fr">
                    ...
                    <div class="bkbook_right-allul">
                        ...
                        <a target="_blank" href="/news/4293.html">
                            <img width="120" height="72" alt="网上买dr钻戒可不可靠" src="/index/images/20150527154522510535113e.jpg" />
                        </a>
                        </div>
                        <!--左边图片end-->
                        <!--右边ul-->
                    ...
                    <div class="bkbook_right-allul">
                        <!--左边图片-->
                        <div class="bkbook_right-fimg fl">
                            <a target="_blank" href="/news/3870.html">
                                <img width="120" height="72" alt="一克拉钻戒保值" src="/index/images/2015042918212650e2902a39.jpg" />
                            </a>
                        </div>
                        <!--左边图片end-->
                    ...
                    <div class="bkbook_right-allul">
                        <!--左边图片-->
                        <div class="bkbook_right-fimg fl">
                            <a target="_blank" href="/news/4547.html">
                                <img width="120" height="72" alt="陆烧林萧求婚戒指是什么" src="/index/images/2015061813430589cb642ca7.jpg" />
                            </a>
                        </div>
                        <!--左边图片end-->
                ...
                <div class="loverit_center2">
                    <div class="loverit_write2">
                        ...
                        <select id="txtArea" style="vertical-align: middle;height:22px;">
                            <option value="0">中国大陆</option>
                            <option value="1">中国香港</option>
                            <option value="2">中国澳门</option> <option value="3">中国台湾</option>
                        </select>
                        <label>先生姓名:</label>
        ...
        <div class="cmain">
            <ul class="Service_ul">
                ...
                <li>
                    ...
                    <a href="index.html/help_se/81.html" rel="nofollow"><p> 一钻双证</p></a>
                </li>
                ...
                <li>
                    ...
                    <a href="index.html/help_se/80.html" rel="nofollow"> <p> 终生保养</p></a>
                </li>
                ...
                <li>
                    ...
                    <a href="index.html/help_se/82.html" rel="nofollow"> <p> 以小换大</p></a>
                </li>
                ...
                <li>
                    ...
                    <a href="index.html/help_se/84.html" rel="nofollow"> <p> 15天退换</p></a>
                </li>
                ...
                <li>
                    ...
                    <a href="index.html/help/74.html" rel="nofollow"> <p> 全国免运费</p></a>
                </li>
                ...
                <li>
                    ...
                    <a href="index.html/help_se/83.html" rel="nofollow"><p> 全程保险</p></a>
                </li>
            </ul>
            <!--服务条款-->
            <div class="service">
                <!--二维码-->
                <div class="erwei fl">
                    <img width="90" height="90" alt="Darry Ring 官方微信" src="/index/images/erwei.jpg" />
                </div>

                <!--中间的联系方式-->
                <div class="know_right fl">
                    <p> 24小时全国免费服务热线</p>
                    <img width="171" height="32" src="/index/images/tel.jpg" />
                    <p class="theshare">
                        <span>关注我们：</span>
                ...
                <ul class="Service_know fr">
                    ...
                    <li>
                        <h3> 关于我们</h3>
                        <p> <a target="_blank" href="index.html/help_ab/66.html" rel="nofollow">权威认证</a></p>
                        <p> <a target="_blank" href="index.html/help_ab/68.html" rel="nofollow">商务合作</a></p>
                        <p> <a target="_blank" href="index.html/help_ab/70.html" rel="nofollow">加入我们</a></p>
                    </li>

                    <!--每一块li-->
                    <li>
                        <h3> 关于购买</h3>
                        <p> <a target="_blank" href="index.html/help/72.html" rel="nofollow">购买流程</a></p>
                        <p> <a target="_blank" href="index.html/help/73.html" rel="nofollow">支付方式</a></p>
                        <p> <a target="_blank" href="index.html/help/74.html" rel="nofollow">配送流程</a></p>
                    </li>

                    <!--每一块li-->
                    <li>
                    <h3> 关于退换</h3>
                        <p> <a target="_blank" href="index.html/help/75.html" rel="nofollow">退货流程</a></p>
                        <p> <a target="_blank" href="index.html/help/76.html" rel="nofollow">办理售后</a></p>
                        <p> <a target="_blank" href="index.html/help_se/84.html" rel="nofollow">15天退换</a></p>
                    </li>

                    <!--每一块li-->
                    <li>
                        <h3> 帮助中心</h3>
                        <p> <a target="_blank" href="index.html/help/71.html" rel="nofollow">注册流程</a></p>
                        <p> <a href="javascript:showxiaon();" rel="nofollow">联系客服</a></p>
                        <p> <a target="_blank" href="index.html/help/78.html" rel="nofollow">网站地图</a></p>
                    </li>

                    <!--每一块li-->
                    <li>
                        <h3> 服务条款</h3>
                        <p> <a target="_blank" href="index.html/help_se/80.html" rel="nofollow">终生保养</a></p>
                        <p> <a target="_blank" href="index.html/help_se/85.html" rel="nofollow">注册协议</a></p>
                        <p> <a target="_blank" href="index.html/help_se/86.html" rel="nofollow">隐私声明</a></p>
                    </li>

                    <!--每一块li-->
                    <li>
                        <h3> DR服务</h3>
                        <p> <a target="_blank" href="/proposelist.aspx?id=18">钻石百科</a></p>
                        <p> <a target="_blank" href="/news/index.aspx">产品百科</a></p>
                        <p> <a target="_blank" href="/propose.aspx">求婚指南</a></p>
                    </li>
                </ul>
            </div>
                <!--条文-->
    ...
    <div style="display:none" class="Ffloat_kf">
        <div class="fkf_top">
            ...
            <div id="BizQQWPA"></div>
            <div onClick="showModel(modelsever);" style="cursor: pointer;" class="qq_hover" id="qqTalk_head"></div>
            <div id="BizQQWPAB" class="sh"></div>
            <div id="bdBridge">
                <a href="javascript:NTKF.im_openInPageChat()"> <img width="75" height="37" src="/index/images/zx.jpg" /></a>
            </div>
        </div>
        <div class="fkf_bottom">
            <img width="92" height="82" alt="Darry Ring 官方微信" src="/index/images/to_erwei.jpg" />
            <a href="#"> <img width="92" height="26" src="/index/images/db.jpg" /></a>
        </div>
    </div>
  ...
  <!--新版右边客服end-->
    ...
    <div style="position: fixed; cursor: pointer; right: 6px; top: 289px; padding-bottom: 152px; z-index: 9999; width: 19px; height: 103px; display: none;" onClick="openserver();" id="openbnt">
        <img width="19" height="103" src="/index/images/server_03.jpg" />
    </div>
        ...
        <div class="cs_top">
            <div class="cs_topcenter">
                ...
                <div style="width:385px; height:20px; float:left; text-align:right; padding-top:20px;">
                    <img width="55" height="9" style="cursor: pointer;" onClick="CloseMaskser()" src="/index/images/popup_window_btn_close.gif" />
                </div>
            </div>
        </div>
